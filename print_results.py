...
# Prints summary statistics over the run
    ...
    # IF print_incorrect_dogs == True AND here were images incorrectly 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (sum(results_dic[key][3:]) == 1):
                print ("Pet is  {} but {} found ".format(results_dic[key][0],results_dic[key][1]))
